                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <thead class="thead-light text-success ">
                                        ...
                                        <tr>
                                            <h3 class="text-danger border p-1">Departure flight <img src="assets/icons8-airplane-50.png" alt=""></h3>
                                    ...
                                    <tbody class="customtable text-warning">
                                        <tr>
                                            ...
                                            @foreach ($position['departure'] as $flight)
                                                ...
                                                <td> <a href="{{ route('detaglio') }}"> <i style="font-size:20px "
                        ...
                        <div class="card p-4">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <thead class="thead-light text-success">
                                        <tr>
                                             <h3 class="text-danger border p-1">Arrival flight  <img src="/assets/icons8-airplane-50 (1).png" alt=""></h3>
                                            </th>
                                            <th scope="col">Company</th>
                                            <th scope="col">City</th>
                                            <th scope="col">Time</th>
